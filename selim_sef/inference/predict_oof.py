...
from inference.predict import get_nadir
...
if __name__ == '__main__':
    ...
    arg('--folds_csv', type=str, help='path to folds file')
    arg('--fold', type=int,default=0 , help='fold num')
    ...
    model.eval()
    data_test = DenseData(data_path=args.data_path, transform=val_transforms, csv_path=args.folds_csv, mode='val', fold=args.fold, nadir='all')
